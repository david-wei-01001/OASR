...
_KIND_X_OFFSET = {
    ...
    "attn_o": 0.22,
    "mlp": 0.0,
    "ln1": 0.35, "ln1_bias": 0.45, "ln2": 0.55, "ln2_bias": 0.65,
}
_KIND_Y_OFFSET = {
    "attn_q": -0.22,
    "attn_k": 0.00,
...
_KIND_LABEL = {
    ...
    "mlp": "MLP",
    "output": "Out",
    "ln1": "LN1", "ln1_bias": "LN1β", "ln2": "LN2", "ln2_bias": "LN2β",
}
_KIND_COLOR = {
    "emb": _C_EMB,
    "attn": _C_ATTN,
    ...
    "mlp": _C_MLP,
    "output": _C_OUTPUT,
    "ln1": _C_LN, "ln2": _C_LN, "ln1_bias": _C_LN_BIAS, "ln2_bias": _C_LN_BIAS,
}
...
def _node_sort_key(key: node_key) -> tuple[int, int, int, str]:
    ...
    kind_rank = {
        ...
        "attn_v": 3,
        "attn_o": 4,
        "ln1": 5, "ln1_bias": 6, "ln2": 9, "ln2_bias": 10,
    }.get(kind, 5)
