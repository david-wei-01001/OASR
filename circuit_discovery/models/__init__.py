...
from .modeling_hubert import CircuitHubert 
...
# model registry
# --------------------------------------------------------------------------------------
CircuitModelClass: TypeAlias = (
    type[CircuitGPT] | type[CircuitPythia] | type[CircuitHubert] 
)
...
MODEL_REGISTRY: dict[str, CircuitModelClass] = {
    ...
    "hubert-base-ls960": CircuitHubert,         
    "wav2vec2-base-960h": CircuitHubert,   
    "wav2vec2-base": CircuitHubert,
}
